    ...
    <>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                {/* TOP */}
                <span
                  className={`absolute w-7 h-[2px] bg-current rounded-full transition-all duration-300 ${
      ...
      >
        ...
        >
          ...
          {/* CTA BUTTON */}
          <button className="absolute bottom-5 left-6 right-6 overflow-hidden rounded-3xl transition-all group cursor-pointer">
            <span className="flex items-center justify-center gap-2 px-4 py-3 bg-white text-black transition-transform duration-300 group-hover:-translate-y-full">
              Get In Touch
              <MdArrowOutward className="text-lg" />
            </span>
          </button>
