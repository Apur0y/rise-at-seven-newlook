    ...
    >
      <div className=" mx-auto px-8  py-2">
        <div className="flex items-center justify-between">
          ...
          <button className="px-6 py-3 rounded-full font-medium hover-button overflow-hidden relative group transition-all duration-300 hover:scale-105">
            <span className="relative z-10 block transition-transform duration-200 group-hover:-translate-y-full">
              Get In Touch
            </span>
