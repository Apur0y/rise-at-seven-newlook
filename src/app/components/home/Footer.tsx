...
export default function Footer() {
  return (
    <footer className="bg-neutral-900 text-white  mx-2 rounded-3xl">
      <div className="col-start-1 row-start-1 grid grid-cols-12 pt-14 pb-6 relative z-20 | lg:py-10 | px-4 | md:px-7 gap-x-3 | md:gap-x-5 gap-y-3 | md:gap-y-7 | js-footer-content">
        {/* Left */}
        <div className="flex flex-col items-start justify-start col-span-12 mb-10 | lg:mb-0 lg:col-span-4 | gap-y-3 | md:gap-y-5">
          <h3 className="text-2xl font-bold">Stay updated with Rise news</h3>
          ...
          <div className="space-y-4 border-l border-white/20 pl-3">
            <ul className="space-y-1">
              {navigationLinks.map((item, index) => (
                <li key={index}>
                  <AnimatedText href="#">{item}</AnimatedText>
                </li>
              ))}
            </ul>
          </div>
