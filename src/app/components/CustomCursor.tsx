    ...
    const handleMouseEnter = (e: Event) => {
      ...
      if (target.classList.contains('cursor-arrow')) {
        ...
        if (cursorInnerRef.current) {
          gsap.to(cursorInnerRef.current, { scale: 1.5, duration: 0.1, ease: 'power2.out' });
        }
  ...
  return (
    ...
    >
      <div ref={cursorInnerRef} className="transition-transform">
        ...
        {cursorType === 'arrow' && (
          <div className="w-16 h-16 bg-teal-100 rounded-full -rotate-45 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center transition-all duration-300">
